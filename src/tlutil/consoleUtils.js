...
// Logging utilities
function log(msg) {console.log(`[${chalk.blue("INFO")}] ${process.pid} |  ${msg}`)};
function ok(msg) {console.log(`[${chalk.green(" OK ")}] ${process.pid} |  ${msg}`)};
function error(msg) {console.log(`[${chalk.redBright("ERR ")}] ${process.pid} |  ${msg}`)}; 
function debug(msg) {if (debugok == true) console.log(`[${chalk.whiteBright("DEBUG")}] ${process.pid} | ${msg}`)};
function warn(msg) {console.log(`[${chalk.yellowBright("WARN")}] ${process.pid} |  ${msg}`)};
function ebug(msg) {}
